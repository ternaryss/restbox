...
public class EditMovieTest {
  ...
  public void setup() {
    ...
    Mockito.when(movieRepo.findFirstByMovId(mockedMovie.getMovId())).thenReturn(mockedMovie);
    ...
    handler = new EditMovie(actorRepo, countryRepo, genereRepo, movieRepo, personRepo);
  }
